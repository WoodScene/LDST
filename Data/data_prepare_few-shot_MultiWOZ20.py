...
def Count_activate_state_number():
    data_dir = "./MULTIWOZ20_preprocess/"+ "train" +".json"
...
if __name__ == '__main__':
    ...
    for data_type in ["train"]:
        ...
        output_filename = "./MULTIWOZ20_preprocess/"+ data_type +"_LLM_few-shot-"+ str(few_shot_ratio) +"percent.json"
        dataset_data = []
