...
# 超参数就是few shot的比例，0.1%、1%、5%、10%、25%
...
def Count_activate_state_number():
    data_dir = "./MULTIWOZ2.4_preprocess/"+ "train" +".json"
...
if __name__ == '__main__':
    ...
    for data_type in ["train"]:
        ...
        output_filename = "./MULTIWOZ2.4_preprocess/"+ data_type +"_LLM_few-shot-"+ str(few_shot_ratio) +"percent.json"
        dataset_data = []
